...
public class TomahawkProjectileRenderer extends EntityRenderer<TomahawkProjectileEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(TomahawkProjectileEntity pEntity) {
        return ResourceLocation.fromNamespaceAndPath(TestMod.MOD_ID, "textures/entity/tomahawk/tomahawk.png");
    }
}
