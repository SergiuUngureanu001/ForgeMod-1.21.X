...
public class ModFoodProperties {
    ...
    public static final FoodProperties GAUNUS = new FoodProperties.Builder().nutrition(10).saturationModifier(0.25f)
            ...
            .effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 2500), 1.0f)
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 2500), 1.0f)
            .effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 2500), 1.0f)
            .effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 2500), 1.0f)
            .effect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 2500), 1.0f)
            .effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 2500), 1.0f)
