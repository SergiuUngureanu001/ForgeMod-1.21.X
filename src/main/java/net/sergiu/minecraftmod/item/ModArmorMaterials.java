...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> ALEXANDRITE_ARMOR_MATERIAL = register("alexandrite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            atribute -> {
                atribute.put(ArmorItem.Type.BOOTS, 5);
                atribute.put(ArmorItem.Type.LEGGINGS, 7);
                atribute.put(ArmorItem.Type.CHESTPLATE, 9);
                atribute.put(ArmorItem.Type.HELMET, 5);
                atribute.put(ArmorItem.Type.BODY, 11);
